...
public class PointerPopupWindow extends PopupWindow {
    ...
    public PointerPopupWindow(Context context, int width) {
        this(context, width, ViewGroup.LayoutParams.WRAP_CONTENT, false);
    }

    public PointerPopupWindow(Context context, int width, boolean isUp) {
        this(context, width, ViewGroup.LayoutParams.WRAP_CONTENT, isUp);
    }

    public PointerPopupWindow(Context context, int width, int height, boolean isUp) {
        super(width, height);
        if(width < 0) {
