...
public class MainNavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public void setViewHolder(int index, TabParam tabParam) {
        ViewHolder holder = mViewHolderList.get(index);
        holder.pageParam = tabParam;
        mViewHolderList.set(index, holder);
        if (mCurrentSelectedTab == index) {
    ...
    public ViewHolder addTab(Class frameLayoutClass, TabParam tabParam) {
...
//        }
    ...
    public static class TabParam {
        public int backgroundColor = android.R.color.darker_gray;
